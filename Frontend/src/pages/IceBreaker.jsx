    ...
    <div className="p-8 mt-8 flex justify-center">
      <div className="w-full ml-[13%] bg-white rounded-2xl shadow-lg p-8">
        ...
        <div className="mb-7">
          ...
          <textarea rows="3" placeholder="E.g., Team-building, fun introduction..." className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 bg-gray-50 resize-none" />
        </div>
        ...
        {showOutput && (
          <div className="mt-10 border border-gray-200 rounded-xl shadow-md p-6 bg-white">
            ...
            <p className="text-gray-700">"Two Truths and a Lie" adapted for students with {selected.disorder || "diverse needs"}. Helps break the ice while promoting memory and focus!</p>
          </div>
        )}
      </div>
    </div>
