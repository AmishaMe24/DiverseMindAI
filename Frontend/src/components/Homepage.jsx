...
>
  ...
  <div className="relative z-30 max-w-6xl">
    ...
    <p className="text-xl mb-6 text-black-900 font-bold  mx-auto">
      A revolutionary platform that tailors STEM education for students with Dyscalculia and Dyslexia.
    </p>
    <Button size="lg" className="bg-blue-600 text-white font-semibold px-6 py-3 rounded-xl shadow-xl hover:bg-blue-700">
      Get Started
    </Button>
  </div>
</section>
      ...
      <section className="py-24 px-6 bg-white">
        <div className="max-w-6xl mx-auto text-center">
          <h2 className="text-4xl font-bold mb-12 text-blue-600">Why Choose Us?</h2>
          <div className="grid md:grid-cols-3 gap-10">
            {features.map((feature, index) => (
              <Card key={index} className="bg-gray-100 shadow-lg border border-gray-300 p-8 rounded-lg hover:shadow-xl transition-shadow">
                <CardContent>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-300 to-teal-200 text-gray-900 text-center relative">
        ...
        <div className="relative z-10">
          <h2 className="text-4xl font-bold mb-6 drop-shadow-lg">Ready to Transform Learning?</h2>
          <p className="mb-8 max-w-3xl mx-auto text-gray-800 text-lg">Join our platform today and make education inclusive for all.</p>
          <Button size="lg" className="bg-teal-600 text-white font-semibold px-8 py-4 rounded-2xl shadow-xl hover:bg-teal-700 transition">
            Sign Up Now
          </Button>
        </div>
      </section>
...
const features = [
  ...
  },
  {
    ...
    description: "Interactive learning tools designed to enhance comprehension.",
    icon: Users,
  },
  {
